...
<head>
	...
	<title>spring-microservices: Deal of day product List</title>
</head>
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<h1>Deal of day product List</h1>

			<ul>
				<c:forEach items="${dealOfDays}" var="dealOfDay">
					<li><a href="dealOfDayDetails?name=${dealOfDay.name}">${dealOfDay.name}</a></li>
				</c:forEach>
			</ul>
